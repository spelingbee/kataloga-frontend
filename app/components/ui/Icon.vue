<template>
  ...
  >
    ...
    <!-- Telegram -->
    <g v-else-if="name === 'telegram'" fill="currentColor" stroke="none">
      <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm4.64 6.8c-.15 1.58-.8 5.42-1.13 7.19-.14.75-.42 1-.68 1.03-.58.05-1.02-.38-1.58-.75-.88-.58-1.38-.94-2.23-1.5-.99-.65-.35-1.01.22-1.59.15-.15 2.71-2.48 2.76-2.69.01-.03.01-.14-.07-.2-.08-.06-.19-.04-.27-.02-.12.02-1.96 1.25-5.54 3.69-.52.36-.99.53-1.41.52-.46-.01-1.35-.26-2.01-.48-.81-.26-1.45-.41-1.39-.86.03-.23.35-.47.96-.71 3.74-1.63 6.24-2.7 7.5-3.21 3.56-1.43 4.3-.17 4.29.32-.01.12-.03.25-.03.38z" />
    </g>
    ...
    <!-- Check Circle 2 -->
    <g v-else-if="name === 'check-circle-2'">
      <circle cx="12" cy="12" r="10" />
    ...
    <!-- Layout Dashboard -->
    <g v-else-if="name === 'layout-dashboard'">
